...
const buildSceneInfoResultDefinition = (
  ...
  englishReplyDraft: `2コマ目で${receiverName}が返答するセリフの簡単な概要。最大5文字程度の日本語で簡潔に。（例: 感謝、共感、同意、照れ、許可、了承、納得、喜び、驚き、依頼、承諾、拒否、快諾、など）`,
});
...
const samples: SceneInfo[] = [
  ...
  },
  {
    ...
    englishReplyDraft: 'エマならできると思っていた',
  },
];
