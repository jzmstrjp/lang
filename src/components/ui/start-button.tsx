...
export const StartButton = ({
  ...
  return (
    <div className="mt-8 flex flex-col items-center gap-4 text-center bg-[var(--background)] p-8 rounded-lg min-w-[80%] sm:min-w-[300px] border border-[var(--start-button-border)]">
