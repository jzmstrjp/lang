...
const problemData: SeedProblemData[] = [
  ...
  //   scenePrompt:
  //     'オフィスのプリンターの調子が悪い場面。紙が詰まっているわけではない。【上半分】プリンターの調子が悪いことを同僚に相談している。表情は無表情。【下半分】相談された同僚が、プリンターを直すために思い切り振りかぶってパンチしている。表情は無表情。その衝撃でプリンターの一部は砕けている。',
  //   senderVoiceInstruction: '悟りを開いた子供のような声',
  //   receiverVoiceInstruction: '悟りを開いた子供のような声',
  //   incorrectOptions: [
  //     'このプリンターはとても高性能だニャー。',
  //     'もう仕事やめたいニャー。',
  //     'タマネギは食べちゃダメだニャ。',
  ...
  //   japaneseReply: 'じゃあ、午後はマタタビでも吸って過ごそうニャ。',
  //   scenePrompt:
  //     '【上半分】オフィスチェアに座って、デスクの上の動かなくなったノートPCを見つめている。表情は無表情。ノートPCの近くには、倒れた花瓶があり、PCにも水がかかっている【下半分】猫用のマタタビを片手に、無表情でアドバイスをしている。',
  //   senderVoiceInstruction: '悟りを開いた子供のような声',
  //   receiverVoiceInstruction: '悟りを開いた子供のような声',
  //   incorrectOptions: [
  //     '仕事は楽しいニャー。',
